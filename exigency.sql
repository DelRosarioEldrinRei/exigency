...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 07, 2018 at 12:47 AM
...
INSERT INTO `emergency` (`emergency_id`, `emergency_name`) VALUES
(1, 'Asthma'),
(2, 'Bleeding'),
(4, 'Burns'),
(6, 'Chest Pain'),
...
INSERT INTO `emergency_info` (`emergency_type_id`, `emergency_id`, `cat_name`, `cat_info`, `pic`) VALUES
...
INSERT INTO `hospital_location` (`hospital_location_id`, `latitude`, `longitude`, `hospital_name`) VALUES
(1, 14.6028, 121.006, 'St. Luke Hospital Global Nephro Training Center'),
(2, 14.5991, 121.015, 'Valenzuela Hospital Santa. Mesa Manila'),
(3, 14.6328, 120.978, 'Amisola Maternity Hospital - Hermosa Street, Manuguit, Tondo'),
(4, 14.6236, 120.962, 'Canossa Health and Social Center Foundation, Inc. - E. Jacinto Street, Magsaysay Village, Tondo'),
(5, 14.6055, 120.979, 'Clinica Arellano General Hospital - Doroteo Jose Street, Santa Cruz'),
(6, 14.5998, 121, 'De Ocampo Memorial Medical Center - Nagtahan Street, Santa Mesa'),
(7, 14.6063, 120.984, 'Dr. Jose Fabella Memorial Hospital - Lope de Vega Street, Santa Cruz'),
(8, 14.6018, 121.015, 'Dr. Mirando Unciano, Sr. Medical Center - V. Mapa Street, Santa Mesa'),
(9, 14.6125, 120.981, 'F. Lanuza Health Center and Lying-in Clinic - Alvarez Street, Santa Cruz'),
(10, 14.6009, 120.965, 'GAT Andres Bonifacio Memorial Medical Center - Delpan Street, Tondo'),
(11, 14.614, 120.989, 'Hospital of the Infant Jesus - Laong Laan Street, Sampaloc'),
(12, 14.6142, 120.982, 'Jose R. Reyes Memorial Medical Center - San Lazaro Compound, Rizal Avenue, Santa Cruz'),
(13, 14.597, 120.972, 'Justice Jose Abad Santos General Hospital - Numancia St. Binondo Manila'),
(14, 14.5819, 120.983, 'Manila Doctors'' Hospital - United Nations Avenue, Ermita'),
(15, 14.618, 120.991, 'Maria Clara Health Center and Lying-in Clinic - Maria Clara corner Prudencio Streets, Sampaloc'),
(16, 14.6033, 120.99, 'Mary Chiles General Hospital - Dalupan Street, Sampaloc'),
(17, 14.5096, 121.013, 'Mary Johnston Hospital - Juan Nolasco Street, Tondo'),
(18, 14.5825, 120.985, 'Medical Center Manila[1] - General Luna Street, Ermita'),
(19, 14.6092, 120.979, 'Metropolitan Medical Center - Masangkay Street, Tondo'),
(20, 14.584, 121.016, 'New Manila District Hospital - Pad. Peo, Santa Cruz'),
(21, 14.5707, 120.993, 'Nephrology Center of Manila - San Andres Street corner Leon Guinto Street, Malate'),
(22, 14.5639, 120.986, 'Ospital ng Maynila Medical Center - Quirino Avenue corner Roxas Boulevard, Malate'),
(23, 14.6076, 120.997, 'Ospital ng Sampaloc - Geronimo Street, Sampaloc'),
(24, 14.6259, 120.978, 'Ospital ng Tondo - Jose Abad Santos Avenue, Tondo'),
(25, 14.5948, 121.022, 'Our Lady of Lourdes Hospital - P. Sanchez Street, Santa Mesa'),
...
INSERT INTO `hotlines` (`line_id`, `line_number`, `line_owner`) VALUES
(1, '911', 'OFFICIAL EMERGENCY HOTLINE'),
(2, '124', 'Phivolcs'),
(3, '117', 'PNP'),
(4, '117', 'Bureau of fire protection'),
(5, '136', 'MMDA'),
(6, '143', 'Red Cross'),
(7, '4211918', 'NDRRMC'),
(8, '132786', 'Office if Civil Defense'),
(9, '4422786', 'PAGASA'),
(10, '5273877', 'Philippine Coastguard'),
(11, '9517119', 'DSWD'),
(12, '7295166', 'Bureau of Fire Protection'),
(13, '2481743', 'Cainta '),
(14, '3866568', 'Caloocan (north)'),
(15, '3245168', 'Caloocan (south)'),
(16, '8443146', 'Makati '),
(17, '184999', 'Malabon'),
(18, '5273087', 'Manila '),
(19, '6461633', 'Marikina'),
(20, '2811111', 'Navotas'),
(21, '9232499', 'Parañaque'),
(22, '8338512', 'Pasay'),
(23, '64331111', 'Pasig'),
(24, '6311111', 'Pateros'),
(25, '112', 'Quezon City'),
...
INSERT INTO `learn` (`learn_id`, `learn_name`) VALUES
(1, 'Pressure Points'),
(2, 'Dressing'),
(3, 'Folds'),
(5, 'Roller Bandage'),
...
INSERT INTO `learn_info` (`learn_type_id`, `learn_id`, `cat_name`, `cat_info`) VALUES
...
(7, 1, 'Hand/Feet Wounds', 'On the inside of the wrist, move away from the thumb towards the tip of the forearm. For foot wounds, trace above the front/top of the foot, right where it meets the shin. In both cases, do not forget to feel for a pulse before applying pressure.'),
...
(12, 3, 'Broad-fold bandage', 'As a broad-fold bandage with the apex folded down to the base twice to immobilise a lower body injury.'),
...
(15, 3, 'Sling', 'In the open form as a sling to support an upper body injury.'),
...
INSERT INTO `prepare` (`prepare_id`, `prepare_name`) VALUES
(1, 'Earthquake'),
(2, 'Fire'),
(3, 'Flood'),
(4, 'Tsunami'),
...
INSERT INTO `prepare_info` (`prepare_type_id`, `prepare_id`, `cat_name`, `cat_info`) VALUES
(1, 1, 'Information', 'An earthquake is a sudden, rapid shaking of the ground caused by the shifting of rocks beneath the earth’s surface. Earthquakes strike suddenly, without warning, and can occur at any time of the year – day or night.'),
...
(10, 2, 'information', 'The greatest cause of death are home fires. Most fire deaths are preventable with careful action. It is important to safeguard your home and be prepared to evacuate should there be a fire.'),
...
(23, 4, 'Information', 'Tsunamis are a series large ocean waves generated by major earthquakes beneath the ocean floor or major landslides into the ocean.'),
